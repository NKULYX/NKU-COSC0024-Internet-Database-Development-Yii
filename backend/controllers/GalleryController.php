...
class GalleryController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if (Yii::$app->request->post('is_create')) {
            $model->gallery_name = Yii::$app->request->post('gallery_name');
            ...
            $model->gallery_time = Yii::$app->request->post('gallery_time');
            $model->path = 'tmp';
            $model->save();
            ...
            if (move_uploaded_file($temp_name, '../../common/static/images/gallery/'.$filename)){
                $model->path = $filename;
            }
            $model->save();
